...
/**
 * Cycles landing page (`/admin/cycles`).
 *
 * Cycle management is committee-scoped in the documented API, so this page
 * lists the committees the admin manages and links each to its cycle
 * management view. Covers loading / error / empty / success states.
 */
  ...
  return (
    ...
    >
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3, maxWidth: 720 }}>
        Cycle management is organised per committee. Choose a committee to view its cycles,
        generate new cycles, transition cycle status, and manage lottery execution.
      </Typography>
      ...
      {isLoading ? (
        ...
        <Paper sx={{ py: 8, px: 3, textAlign: 'center' }}>
          ...
          <Typography variant="body2" color="text.disabled" sx={{ mb: 3 }}>
            Create a committee first — you can manage its cycles once it exists.
          </Typography>
